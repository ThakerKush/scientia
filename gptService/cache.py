        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {'role': 'system', 'content': """You are a helpful tutor for theory, you will help user to memorize the given content, you will summaries the content into easy to remember pointers and provide with acronyms to remember 
                 the content if possible ( try your hardest to give out a good and rememberable acronym that rhymes if it doesn't rhyme then don't bother ). Your response should be like this Title: <title> Content: <content>"""},
                {
                    'role': 'user',
                    'content': content
                }
